...
(function (root, factory) {
    ...
    function requirement(writer, value, name, includeRoute) {
    ...
    function setup(writer, value, setupIndex) {
        ...
        for (const slot of equippedSlots) {
            ...
            requirement(writer, equipment[slot], "equipment." + slot, true);
        }
        ...
        for (const slot of alternativeSlots) {
            ...
            entries.forEach((entry, index) => requirement(writer, entry,"alternatives." + slot + "[" + index + "]", false));
        }
